<?php get_header(); ?>
      ...
      <div id="carouselIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="container idicator_container">
          ...
          if ($query->have_posts(  ) ) :
              ...
              while ($query->have_posts(  )) : $query->the_post(  );
              $active = ($count == 0) ? 'active' : ' ';?>
            <li data-target="#carouselIndicators" data-slide-to="<?php echo $count; ?>" class="<?php echo $active; ?>"></li>
            <?php
              $count = $count + 1;
              endwhile;
            endif;
      ...
      <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="box">
              <div class="img-box">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/client.png" alt="">
              </div>
              <div class="detail-box">
                <h4>
                  Minim Veniam
  ...
  <section class="contact_section layout_padding">
    <div class="contact_bg_box">
      <div class="img-box">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/contact-bg.jpg" alt="">
      </div>
    </div>
    <div class="container">
      <div class="heading_container heading_center">
